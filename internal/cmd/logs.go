...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View hiagent logs",
	Long:  `View the logs generated by HiAgent. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cfg, err := config.Load(cwd, dataDir, nil, false)
		if err != nil {
			return fmt.Errorf("failed to load configuration: %v", err)
		}
		logsFile := filepath.Join(cfg.Config().Options.DataDirectory, "logs", "hi_agent.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a hiagent project. No logs found.")
			return nil
		}
