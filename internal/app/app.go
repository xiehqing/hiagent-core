...
import (
	...
	"github.com/xiehqing/hiagent-core/internal/log"
	...
	"github.com/xiehqing/hiagent-core/internal/shell"
	...
	"github.com/xiehqing/hiagent-core/internal/update"
...
func (app *App) GetDefaultSmallModel(providerID string) config.SelectedModel {
	...
	knownProviders, _ := config.KnownProviders(app.config.Conn())
