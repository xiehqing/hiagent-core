...
func TestHiagentInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHiagentInfo(cfg, nil, nil, nil, nil)
...
func TestHiagentInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/hiagent/hiagent.json",
		"/project/.hiagent/hiagent.json",
	)
	output := buildHiagentInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/hiagent/hiagent.json")
	require.Contains(t, output, "/project/.hiagent/hiagent.json")
}

func TestHiagentInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildHiagentInfo(cfg, mgr, nil, nil, nil)
...
func TestHiagentInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.hiagent",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.hiagent")
	require.Contains(t, output, "debug = true")
}

func TestHiagentInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildHiagentInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildHiagentInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestHiagentInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "hiagent.json")
	...
	output := buildHiagentInfo(store, nil, nil, nil, nil)
...
func TestHiagentInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "hiagent-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("hiagent-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHiagentInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "hiagent-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestHiagentInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "hiagent-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestHiagentInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestHiagentInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
