...
import (
	...
	agenttools "github.com/xiehqing/hiagent-core/internal/agent/tools"
	"github.com/xiehqing/hiagent-core/internal/agent/tools/mcp"
	"github.com/xiehqing/hiagent-core/internal/app"
	"github.com/xiehqing/hiagent-core/internal/commands"
	...
	"github.com/xiehqing/hiagent-core/internal/ui/anim"
	...
	"github.com/xiehqing/hiagent-core/internal/ui/completions"
	"github.com/xiehqing/hiagent-core/internal/ui/dialog"
	fimage "github.com/xiehqing/hiagent-core/internal/ui/image"
...
func (m *UI) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		text := fmt.Sprintf("HiAgent update available: v%s 鈫?v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			text = fmt.Sprintf("This is a development version of HiAgent. The latest version is v%s.", msg.LatestVersion)
		}
		ttl := 10 * time.Second
...
func (m *UI) Draw(scr uv.Screen, area uv.Rectangle) *tea.Cursor {
	...
	if os.Getenv("HIAGENT_UI_DEBUG") == "true" {
...
func (m *UI) View() tea.View {
	...
	v.WindowTitle = "hiagent " + home.Short(m.com.Workspace.WorkingDir())
...
// renderLogo renders the HiAgent logo with the given styles and dimensions.
